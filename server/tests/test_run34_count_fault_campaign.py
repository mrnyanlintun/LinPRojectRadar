...
# subject is D1.4 -- 1 module id removed from the registry at Run 96 or Run 97 and no module
# in service -- so there is nothing here for it to qualify. Before this guard it died with
# campaign_safety.CampaignTreeDirty: tree dirty at start of test_run34_count_fault_campaign.py:  M REPORT_2026-08-14_run27-98-module-remediation-matrix.
...
print("RETIRED: test_run34_count_fault_campaign.py measures D1.4, removed at Run 96/97 (88e6ca0); excluded from qualification coverage "
