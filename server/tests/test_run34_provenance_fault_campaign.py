...
_cs_arm(_cs_pl.Path(ROOT), "test_run34_provenance_fault_campaign.py",
        allow=["code_audit/run34_ph1_holdout_result.csv", "code_audit/run34_provenance_fault_injection_results.csv"])
# -------------------------------------------------------------------------------------------
