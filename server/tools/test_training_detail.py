...
# subject is A1.1,B2.14 -- 2 module ids removed from the registry at Run 96 or Run 97 and no module
...
print("RETIRED: test_training_detail.py measures A1.1,B2.14, removed at Run 96/97 (88e6ca0); excluded from qualification coverage "
