...
# subject is A4.1,B2.9,B3.3,B4.1,B4.3,B4.7 -- 6 module ids removed from the registry at Run 96 or Run 97 and no module
# in service -- so there is nothing here for it to qualify. Before this guard it died with
# campaign_safety.CampaignTreeDirty: tree dirty at start of run32_closure_fault_campaign.py:  M REPORT_2026-08-14_run27-98-module-remediation-matrix.md;
...
print("RETIRED: run32_closure_fault_campaign.py measures A4.1,B2.9,B3.3,B4.1,B4.3,B4.7, removed at Run 96/97 (88e6ca0); excluded from qualification coverage "
...
_cs_arm(_cs_pl.Path(ROOT), "run32_closure_fault_campaign.py",
        allow=["code_audit/run32_closure_fault_injection.csv", "code_audit/run32_participant_package_v7_checksums.sha256"])
# -------------------------------------------------------------------------------------------
