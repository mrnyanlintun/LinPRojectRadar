...
# subject is B4.1,B4.2,B4.3,B4.4,B4.5,B4.6 -- 6 module ids removed from the registry at Run 96 or Run 97 and no module
# in service -- so there is nothing here for it to qualify. Before this guard it died with
# app.simulation.registry.MissingModuleError: B4.1 is not in the module registry
...
print("RETIRED: test_run19_category_10.py measures B4.1,B4.2,B4.3,B4.4,B4.5,B4.6, removed at Run 96/97 (88e6ca0); excluded from qualification coverage "
