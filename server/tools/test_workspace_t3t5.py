...
# subject is B4.7,D1.1,D1.2,D1.3,D1.4,D1.5 -- 6 module ids removed from the registry at Run 96 or Run 97 and no module
# in service -- so there is nothing here for it to qualify. Before this guard it died with
# KeyError: 'portfolio_snapshot'
...
print("RETIRED: test_workspace_t3t5.py measures B4.7,D1.1,D1.2,D1.3,D1.4,D1.5, removed at Run 96/97 (88e6ca0); excluded from qualification coverage "
