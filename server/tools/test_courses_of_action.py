...
# subject is B4.7 -- 1 module id removed from the registry at Run 96 or Run 97 and no module
...
print("RETIRED: test_courses_of_action.py measures B4.7, removed at Run 96/97 (88e6ca0); excluded from qualification coverage "
