...
# Distinctive markers planted into the package. If any appears in a pre-lock response, the
# treatment has reached the participant.
...
# is exactly how the real leak this phase found was shaped — the key was stripped, the sentence
# was not. Scanned case-insensitively as whole words.
