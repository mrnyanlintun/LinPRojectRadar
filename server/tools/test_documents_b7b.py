...
# subject is B4.7,C1.2,C1.4 -- 3 module ids removed from the registry at Run 96 or Run 97 and no module
...
print("RETIRED: test_documents_b7b.py measures B4.7,C1.2,C1.4, removed at Run 96/97 (88e6ca0); excluded from qualification coverage "
