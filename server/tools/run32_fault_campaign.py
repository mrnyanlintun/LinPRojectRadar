...
# subject is B2.18,B2.19,B4.1,B4.2,B4.3,B4.4 -- 6 module ids removed from the registry at Run 96 or Run 97 and no module
# in service -- so there is nothing here for it to qualify. Before this guard it died with
# campaign_safety.CampaignTreeDirty: tree dirty at start of run32_fault_campaign.py:  M REPORT_2026-08-14_run27-98-module-remediation-matrix.md;  M asse
...
print("RETIRED: run32_fault_campaign.py measures B2.18,B2.19,B4.1,B4.2,B4.3,B4.4, removed at Run 96/97 (88e6ca0); excluded from qualification coverage "
