#!/usr/bin/env python3
"""
RUN 57. THE SUCCESSOR FREEZE CANDIDATE IDENTITY.

Writes research/freeze/run57_freeze_candidate_identity.json in exactly the shape Run 41 wrote its
...
Usage: python tools/build_run57_candidate_identity.py [--candidate <commit>]
"""
...
PARENT_IDENTITY = FREEZE / "run56_freeze_candidate_identity.json"
...
def main() -> int:
    ...
    out: dict = {
        ...
        "supersession_reason": (
            "RUN 57. THE TWO RESET CONTROLS MERGED INTO ONE, AND THE OTHER REMOVED. THREE "
            "participant-visible files moved -- assets/js/ingest.js, assets/js/detail.js and assets/css/radar.css -- "
            "and NOT ONE is sequence-bearing, so this link carries NO sequence exception and "
    ...
    target = FREEZE / "run57_freeze_candidate_identity.json"
