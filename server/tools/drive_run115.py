...
# RUN 119, SECTIONS 5 AND 2. Candidate A 297 -> 303 and candidate B 187 -> 193.
# SECTION 5 adds `commissioning_items_total`
...
# SECTION 2 adds `inspections_performed` and `active_work_packages` to `quality_audit_report`
