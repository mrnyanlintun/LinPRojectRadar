...
# subject is A5.4 -- 1 module id removed from the registry at Run 96 or Run 97 and no module
# in service -- so there is nothing here for it to qualify. Before this guard it died with
# app.simulation.registry.MissingModuleError: A5.4 is not in the module registry
...
print("RETIRED: test_run29_a54_leakage.py measures A5.4, removed at Run 96/97 (88e6ca0); excluded from qualification coverage "
