...
_cs_arm(_cs_pl.Path(ROOT), "test_run20_cycle12_fault_evidence.py",
        allow=["code_audit/run20_anti_fossilization_register.csv", "code_audit/run20_cycle12_cycle3_fault_injection.csv", "code_audit/run20_fault_injection_results.csv"])
# -------------------------------------------------------------------------------------------
