...
# RUN 63 minted v26: TWO of the sixty-nine moved -- assets/js/detail.js and
# assets/js/neural_flow.js -- and NEITHER is sequence-bearing, so this link too carries NO
# exception record and DECLARES that emptiness rather than omitting it.
check(PP.CURRENT.identifier == "og-participant-2026.08-v26",
      "the current participant package is v26", PP.CURRENT.identifier)
