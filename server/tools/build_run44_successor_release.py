...
def main() -> int:
    ...
    (artifact_out(FREEZE / "RUN44_SUCCESSOR_FREEZE_RECORD.json")).write_text(
...
stamps.
"""
    (artifact_out(FREEZE / "RUN44_SUCCESSOR_FREEZE_REPORT.md")).write_text(report, encoding="utf-8")
