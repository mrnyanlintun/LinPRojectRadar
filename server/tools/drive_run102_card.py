"""
RUN 102. THE OWNER'S OWN ROUTE, AND THE FIVE THINGS THIS RUN HAS TO PROVE.
...
STAMP=str(int(time.time())); ADMIN="r102-"+STAMP; BAC=4_000_000; END="2026-03-31"; PID="PRJ-R102-"+STAMP
