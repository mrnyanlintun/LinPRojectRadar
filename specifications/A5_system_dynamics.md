...
**All seven are bandless.** Each reports calibration-pending with the standard note verbatim: *"The
...
## The abstention sentences all seven share

All seven take their structure through `canonical_v4.require_v4_structure`. Writing `W` for the
