...
**2. The evidence is not qualified for the use.** All four modules are **gated**: the evidence is
put through Category 9 qualification for the module's declared use before the canonical function is
reached. Where it does not qualify, the module abstains in these exact words:
