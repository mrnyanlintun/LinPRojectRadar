/* ============================================================
   ...
   Display module numbering (final / 2026 reorder):
     ...
     19  Agent-Based Governance Model                   — Decision output (LAST)
...
(function () {
  ...
  function m2_8(p) {
    ...
    return panel("2.8", "Look-Ahead Schedule Health", st,
      ...
      `<div class="dd-canvas-wrap"><canvas class="dd-chart-canvas" data-chart="lookahead3d" data-nodrag="1"></canvas><p class="dd-canvas-hint">scroll=zoom · shift+drag=pan · 2D view</p></div>` +
      `<div class="dd-grid">${
