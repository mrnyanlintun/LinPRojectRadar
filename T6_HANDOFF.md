...
**Authority manifest repointed** to `code_audit/run35_authority_tree.sha256` (5 files) so the
Run-35 protocol is walked and pinned; Run-34 and Run-22 authority manifests kept addressable. The
**production** manifest regenerated byte-identical — the mechanical proof that no production byte
moved.
